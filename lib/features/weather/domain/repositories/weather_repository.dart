...
abstract class WeatherRepository {
  Future<Either<AppException, WeatherEntity>> getCurrentWeather({double? lat, double? lon});

  Future<Either<AppException, List<ForecastEntity>>> getWeatherForecast({double? lat, double? lon});
}
